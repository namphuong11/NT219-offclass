...
// extern "C"
// {
//     __declspec(dllexport) bool key_gen(const char *filePrivate, const char *filePublic, const char *format, const int keysize);
...
int main(int argc, char *argv[])
{
    ...
    else if (command == "sign")
    {
        ...
        cout << "\n----------------------------------------------------------" << endl;
        cout << "Overview Signing Test" << endl;
        cout << "Signing time: " << totalDuration << " milliseconds" << endl;
        cout << "----------------------------------------------------------" << endl;
        if (result == 0)
        {
    ...
    else if (command == "verify")
    {
        ...
        cout << "\n----------------------------------------------------------" << endl;
        cout << "Overview Verify Test" << endl;
        cout << "Verify time: " << totalDuration << " milliseconds" << endl;
        cout << "----------------------------------------------------------" << endl;
        if (result == 0)
        {
